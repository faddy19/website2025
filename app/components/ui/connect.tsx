...
export function Connect() {
  ...
  return (
    <section className="container relative mx-auto mb-20 mt-6">
                ...
                <div className="flex h-full flex-col justify-center gap-10 p-4 md:h-[300px] md:flex-row">
                  ...
                  >
                    ...
                    <div id="pointer" className="absolute">
                      ...
                      <span className="relative -top-1 left-3 rounded-3xl bg-blue-500 px-2 py-1 text-xs text-white">
                        Capsula
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="-mt-20 flex h-full flex-col justify-center p-2 md:-mt-4 md:ml-10 md:w-[400px]">
                    ...
                    <p className="mb-4 text-center text-slate-400">
                      Let's discuss how we can help your business grow with AI-powered solutions
                    </p>
                    <div className="flex flex-wrap justify-center gap-2">
                      <a
                        href="https://cal.com/fatih-damat/30min"
                        target="_blank"
                      ...
                      <a
                        ...
                        className={cn(
                          "inline-flex h-10 w-10 items-center justify-center rounded-md border border-input bg-background text-foreground hover:bg-accent hover:text-accent-foreground"
                        )}
                      >
                      ...
                      <a
                        href="https://www.linkedin.com/company/68487962/"
                        target="_blank"
                        rel="noopener noreferrer"
                        className={cn(
                          "inline-flex h-10 w-10 items-center justify-center rounded-md border border-input bg-background text-foreground hover:bg-accent hover:text-accent-foreground"
